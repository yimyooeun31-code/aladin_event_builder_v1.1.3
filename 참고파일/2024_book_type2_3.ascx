...
<!--탭-->
    <div class="swiper-container monly_swiper_tab RandomTab">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"><a href="/events/wevent.aspx?EventId=258106&idx=2#dw">중학교</a></div>
            <div class="swiper-slide on"><a href="/events/wevent.aspx?EventId=258106&idx=3#dw">고등학교</a></div>
        </div>
    </div>
<!--탭-->        
